...
| one | 12 键薄膜键盘 |
| Two | 300 欧姆 1/4 瓦电阻 |
| oneoneoneoneoneoneoneone(几个) | 绿色发光二极管红色发光二极管 HC-SR501 PIR 传感器模块 YwRobot 模块，两个继电器 TMP36 温度传感器 0.1 uF 陶瓷英特尔迅驰无线-N 135 mPCIe 或以太网面包板(400 分够了)杜邦电线，母头对公头，以及跳线 |
