...
Aliaimg/apache_pb.gif /usr/share/httpd/noindimg/apache_pb.gif
Aliaimg/poweredby.png /usr/share/httpd/noindimg/poweredby.png
```
...
这让我们进入了一个完全不同的 Shell，一个在`MariaDB`程序中的 Shell，它使我们能够操纵`MariaDB`控制的数据库。
