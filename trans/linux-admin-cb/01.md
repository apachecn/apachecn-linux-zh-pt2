...
![](assets/544d0efc-3187-468b-8526-6401b6e1f151.png)
...
![](assets/7a4e580a-3f97-4ff6-873f-9e9a712d3e77.png)
...
![](assets/36bc9a7e-cc61-4b4f-b6a8-aa6b8d836e9c.png)
...
![](assets/c216e71b-0a2b-4123-b31e-3dad56fa2dd0.png)
...
![](assets/cfad055f-aa52-469d-862f-8b0d00376cda.png)
...
![](assets/b021f44a-a3f4-4114-b327-46d3fec2f187.png)
...
![](assets/901711d3-0acd-4807-a9fa-6a383558659f.png)
...
![](assets/afea01e8-6057-4d62-87c5-1022d55eefda.png)
...
![](assets/374bb271-1b2f-4455-a4db-2e0798dd305e.png)

我们终于完成了(相当基本的)配置。点击主屏幕底部的开始安装按钮。

您将看到安装开始，并在等待时看到以下屏幕:

![](assets/3aab7464-a2be-4122-b5f4-5e80ea64ca0f.png)
...
![](assets/f7f408f0-9da3-48a0-adec-098a9b8860aa.png)
...
![](assets/fffbf2d8-5938-46fe-b6a4-734366bf27e6.png)

我们将使用安装时创建的用户，而不是 root 用户。

请注意，您还会获得自上次登录以来的一些登录尝试信息。在这种情况下，我第一次尝试登录失败，它告诉我:

![](assets/5fa84258-fb53-4a5c-bd70-a4f1154c4afd.png)
...
![](assets/24e3007d-88b0-4d93-91ce-faabf858a0f6.png)

# 从主机终端登录

因为使用 VirtualBox 界面有些麻烦(使复制和粘贴等事情变得棘手)，所以有一种更优雅的方式来连接和交互我们的机器是有意义的。

**安全外壳** ( **SSH** )是我们将用于此的工具，因为它提供了一种快速安全的连接远程机器的方式。
...
![](assets/e611068c-e618-4953-84aa-90a23759b082.png)

在弹出的新窗口中，单击以在右侧添加新规则，并用以下屏幕截图中的设置填充它，如果不同，则替换您的来宾 IP:

![](assets/11ee068c-ed4c-4ab1-a961-73ed0d7b2295.png)
...
![](assets/1ba8e1b1-413e-44a9-8c79-18d982f8019d.png)
