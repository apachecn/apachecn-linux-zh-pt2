...
![9781430268390_Fig04-01.jpg](images/9781430268390_Fig04-01.jpg)
...
![9781430268390_Fig04-02.jpg](images/9781430268390_Fig04-02.jpg)

[图 4-2](#_Fig2) 。将伺服连接到英特尔伽利略
...
![9781430268390_Fig04-03.jpg](images/9781430268390_Fig04-03.jpg)
...
![9781430268390_Fig04-04.jpg](images/9781430268390_Fig04-04.jpg)
...
![9781430268390_Fig04-05.jpg](images/9781430268390_Fig04-05.jpg)
...
![Image](images/sq.jpg) **注意**在串口写的时候，使用了`println()`的方法，因为它处理字符串更容易。然而，如果您正在传输原始字节或整数，您可以使用`write()`方法来代替。

运行草图后，通过选择工具![image](images/arrow.jpg)串行监视器或按 CTRL+SHIFT+M 打开 IDE 串行控制台。您应该会在调试串行控制台中看到类似以下消息的内容:
...
如果您运行此代码，并使用工具![image](images/arrow.jpg)串行监视器或按 CTRL+SHIFT+M 检查 IDE 串行控制台，您将看到类似如下的输出。
...
执行草图，使用工具![image](images/arrow.jpg)串行监视器或按 CTRL+SHIFT+M 打开 IDE 串行控制台。在第一次测试中，即使您装配了推荐的电路，也不要按按钮。只需运行它，您将能够在串行控制台中看到以下输出:
...
`setup()`方法以三秒钟的延迟开始，让您有机会使用工具![image](images/arrow.jpg)串行监视器或 CTRL+SHIFT+M 打开 IDE 串行控制台。
...
![9781430268390_Fig04-06.jpg](images/9781430268390_Fig04-06.jpg)
...
运行草图，通过选择工具![image](images/arrow.jpg)串行监视器或按 CTRL+SHIFT+M 打开 IDE 串行控制台。然后，每隔 20 秒尝试按一下按钮。如果无法读取脉冲，IDE 串行控制台将显示`0`；否则，读数以微秒显示。
...
![9781430268390_Fig04-07.jpg](images/9781430268390_Fig04-07.jpg)
...
![9781430268390_Fig04-08.jpg](images/9781430268390_Fig04-08.jpg)
...
![9781430268390_Fig04-09.jpg](images/9781430268390_Fig04-09.jpg)
...
![9781430268390_Fig04-10.jpg](images/9781430268390_Fig04-10.jpg)
...
![9781430268390_Fig04-11.jpg](images/9781430268390_Fig04-11.jpg)
...
![9781430268390_Fig04-12.jpg](images/9781430268390_Fig04-12.jpg)
...
![9781430268390_Fig04-13.jpg](images/9781430268390_Fig04-13.jpg)
...
3.  再次打开 IDE，从菜单中选择草图![image](images/arrow.jpg)导入库。检查`DHT11_Galileo`是否列出。如果是，打开库的`examples`文件夹中名为`DHT_4_Galileo.ino`的草图。您也可以使用菜单选择文件![image](images/arrow.jpg)示例![image](images/arrow.jpg)DHT 11 _ Galileo![image](images/arrow.jpg)DHT 11 _ 4 _ Galileo。如果库不存在，请检查库是否按照建议正确安装。还可以进一步了解`http://arduino.cc/en/Guide/Libraries` *安装的库。*
...
运行草图后，通过选择工具![image](images/arrow.jpg)串行监视器或按 CTRL+SHIFT+M 键打开 IDE 串行控制台。
...
![9781430268390_Fig04-14.jpg](images/9781430268390_Fig04-14.jpg)
...
![9781430268390_Fig04-15.jpg](images/9781430268390_Fig04-15.jpg)
